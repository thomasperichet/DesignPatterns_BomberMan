...
public class PanelBomberman extends JPanel{
		...
		for(int x=0; x<taille_x; x++)
		{
			...
			for(int y=0; y<taille_y; y++)
			{
				if (walls[x][y]){
					...
					try {
						Image img = ImageIO.read(new File("src/image/wall.png"));
					...
					try {
						Image img = ImageIO.read(new File("src/image/brique_2.png"));
						g.drawImage(img, (int)position_x, (int)position_y, (int)stepx, (int)stepy, this);
					} catch (IOException e) {
						e.printStackTrace();
					}
					...
					try {
						Image img = ImageIO.read(new File("src/image/grass.png"));
						g.drawImage(img, (int)position_x, (int)position_y, (int)stepx, (int)stepy, this);
					} catch (IOException e) {
						e.printStackTrace();
					}
	...
	void dessine_Agent(Graphics g, InfoAgent infoAgent)
	{
		...
		try {
			if(infoAgent.getType() == 'R') {
				img = ImageIO.read(new File("src/image/" + infoAgent.getType() + direction + this.cpt % 2 + ".png"));	
			}else {
				img = ImageIO.read(new File("src/image/" + infoAgent.getType() + direction + this.cpt % 3 + ".png"));
			}
		} catch (IOException e) {
			e.printStackTrace();
		}			
	...
	void dessine_Items(Graphics g, InfoItem item){
		...
		if (item.getType() == ItemType.FIRE_UP) {
			try {
				Image img = ImageIO.read(new File("src/image/Item_FireUp.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
		...
		if (item.getType() == ItemType.FIRE_DOWN) {
			try {
				Image img = ImageIO.read(new File("src/image/Item_FireDown.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
		...
		if (item.getType() == ItemType.BOMB_UP) {
			try {
				Image img = ImageIO.read(new File("src/image/Item_BombUp.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
		...
		if (item.getType() == ItemType.BOMB_DOWN) {
			try {
				Image img = ImageIO.read(new File("src/image/Item_BombDown.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
		...
		if (item.getType() == ItemType.FIRE_SUIT) {
			try {
				Image img = ImageIO.read(new File("src/image/Item_FireSuit.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
		...
		if (item.getType() == ItemType.SKULL) {
			try {
				Image img = ImageIO.read(new File("src/image/Item_Skull.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
	...
	void dessine_Bomb(Graphics g, InfoBomb bomb)
	{
		...
		if (bomb.getStateBomb() == StateBomb.Step1 ){
			...
			try {
				Image img = ImageIO.read(new File("src/image/Bomb_0.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			try {
				Image img = ImageIO.read(new File("src/image/Bomb_1_jaune.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			try {
				Image img = ImageIO.read(new File("src/image/Bomb_2_rouge.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			try {
				Image img = ImageIO.read(new File("src/image/Range_CENTRE.png"));
				g.drawImage(img, (int)pos_x, (int)pos_y, (int)stepx, (int)stepy, this);
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			for (int i = 1 ; i <= range; i++){
				...
				if(py+i < map.getSizeY()) {
					if(i == range ) {
						try {
							Image img = ImageIO.read(new File("src/image/Range_SOUTH_Fin.png"));
						...
						try {
							Image img = ImageIO.read(new File("src/image/Range_SOUTH.png"));
							g.drawImage(img, (int)pos_x, (int)(pos_y + (stepy*i)), (int)stepx, (int)stepy, this);
						} catch (IOException e) {
							e.printStackTrace();
						}
				...
				if(py-i >= 0) {
					if(i == range) {
						try {
							Image img = ImageIO.read(new File("src/image/Range_NORTH_Fin.png"));
							g.drawImage(img, (int)pos_x, (int)(pos_y - (stepy*i)), (int)stepx, (int)stepy, this);
						} catch (IOException e) {
							e.printStackTrace();
						}
						...
						try {
							Image img = ImageIO.read(new File("src/image/Range_NORTH.png"));
							g.drawImage(img, (int)pos_x, (int)(pos_y - (stepy*i)), (int)stepx, (int)stepy, this);
						} catch (IOException e) {
							e.printStackTrace();
						}
				...
				if(px+i < map.getSizeX()) {
					if( i == range ) {
						try {
							Image img = ImageIO.read(new File("src/image/Range_EAST_Fin.png"));
						...
						try {
							Image img = ImageIO.read(new File("src/image/Range_EAST.png"));
							g.drawImage(img, (int)(pos_x + (stepy*i)), (int)(pos_y), (int)stepx, (int)stepy, this);
						} catch (IOException e) {
							e.printStackTrace();
						}
				...
				if(px-i >= 0) {
					if( i == range) {
						try {
							Image img = ImageIO.read(new File("src/image/Range_WEST_Fin.png"));
							g.drawImage(img, (int)(pos_x - (stepy*i)), (int)(pos_y), (int)stepx, (int)stepy, this);
						} catch (IOException e) {
							e.printStackTrace();
						}
						...
						try {
							Image img = ImageIO.read(new File("src/image/Range_WEST.png"));
							g.drawImage(img, (int)(pos_x - (stepy*i)), (int)(pos_y), (int)stepx, (int)stepy, this);
						} catch (IOException e) {
							e.printStackTrace();
						}
